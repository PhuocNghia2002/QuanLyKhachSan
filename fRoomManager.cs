...
namespace QuanLyKhachSan
{
    public partial class fRoomManager : Form
    {
        ...
        private void btnDeleteService_Click(object sender, EventArgs e)
        {
            ...
            {
                if (BillInfoDAO.Instance.DeleteBillInfo())
                {
                    MessageBox.Show("Xoá dịch vụ vào thành công!");
                    ShowBill(room.ID);
                }
                else
                {
                    MessageBox.Show("Xoá dịch vụ thất bại!");
                }
            }
        }

        private void fRoomManager_Load(object sender, EventArgs e)
        {
