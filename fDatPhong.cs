...
namespace QuanLyKhachSan
{
    public partial class fDatPhong : Form
    {
        ...
        private void btnUpdateCustomerByRoom_Click(object sender, EventArgs e)
        {
            int idCustomer = (cbCustomer.SelectedItem as Customer).ID;
            int idRoom = (cbRoom.SelectedItem as Room).ID;
            int idRoomtype = (cbRoomtype.SelectedItem as RoomType).ID;
            if (BillDAO.Instance.UpdateBill(idCustomer, idRoom, idRoomtype))
            {
        ...
        private void btnDeleteCustomerByRoom_Click(object sender, EventArgs e)
        {
            int idRoom = (cbRoom.SelectedItem as Room).ID;
            if (BillDAO.Instance.DeleteBill(idRoom))
            {
            ...
            {
                MessageBox.Show("Xoá phòng thất bại!!!");
            }
        }
    }
}
